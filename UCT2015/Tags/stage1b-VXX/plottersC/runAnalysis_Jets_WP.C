...
void makePlots( const char* binning, float PUCut ) {
  ...
  if( debug ) {
    ...
    sprintf(filenamePNG, "./uct15-plots/rate/Jets/%s/isoStudies/png/rlx_jets_%0.2f.png" , PUopt.Data(), PUCut);
    sprintf(filenameEPS, "./uct15-plots/rate/Jets/%s/isoStudies/eps/rlx_jets_%0.2f.eps" , PUopt.Data(), PUCut);
