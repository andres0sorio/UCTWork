...
void makePlots( const char* binning, float PUCut ) {
  ...
  if( debug ) {
    ...
    sprintf(filenamePNG, "./slhc-plots/rate/Taus/%s/isoStudies/png/rlx_tau_cluster_%0.2f.png" , PUopt.Data(), PUCut);
    sprintf(filenameEPS, "./slhc-plots/rate/Taus/%s/isoStudies/eps/rlx_tau_cluster_%0.2f.eps" , PUopt.Data(), PUCut);
    sprintf(filenameCpp, "./slhc-plots/rate/Taus/%s/isoStudies/png/rlx_tau_cluster_%0.2f.C"   , PUopt.Data(), PUCut);
  ...
  if( debug ) {
    ...
    sprintf(filenamePNG, "./slhc-plots/rate/Taus/%s/isoStudies/png/rlx_tau_Iso_PU_%0.2f.png" , PUopt.Data(), PUCut);
    sprintf(filenameEPS, "./slhc-plots/rate/Taus/%s/isoStudies/eps/rlx_tau_Iso_PU_%0.2f.eps" , PUopt.Data(), PUCut);
    sprintf(filenameCpp, "./slhc-plots/rate/Taus/%s/isoStudies/png/rlx_tau_Iso_PU_%0.2f.C"   , PUopt.Data(), PUCut);
  ...
  for( int k=0; k<1; ++k) {
    ...
    sprintf(filenamePNG, "./slhc-plots/rate/Taus/%s/isoStudies/png/rlx_tau_Iso_CMP_%0.2f_%0.2f.png" , PUopt.Data(), isoCut1, PUCut );
    sprintf(filenameEPS, "./slhc-plots/rate/Taus/%s/isoStudies/eps/rlx_tau_Iso_CMP_%0.2f_%0.2f.eps" , PUopt.Data(), isoCut1, PUCut );
    sprintf(filenameCpp, "./slhc-plots/rate/Taus/%s/isoStudies/png/rlx_tau_Iso_CMP_%0.2f_%0.2f.C"   , PUopt.Data(), isoCut1, PUCut );
  ...
  if (! debug ) {
    ...
    sprintf(filenamePNG, "./slhc-plots/rate/Taus/%s/isoStudies/png/rlx_tau_Iso_All_CMP_%0.2f_%0.2f.png" , PUopt.Data(), isoCut1, PUCut );
    sprintf(filenameEPS, "./slhc-plots/rate/Taus/%s/isoStudies/eps/rlx_tau_Iso_All_CMP_%0.2f_%0.2f.eps" , PUopt.Data(), isoCut1, PUCut );
    sprintf(filenameCpp, "./slhc-plots/rate/Taus/%s/isoStudies/png/rlx_tau_Iso_All_CMP_%0.2f_%0.2f.C"   , PUopt.Data(), isoCut1, PUCut );
