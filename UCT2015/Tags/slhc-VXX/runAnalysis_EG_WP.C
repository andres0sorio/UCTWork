...
void makePlots( const char* binning, float PUCut ) {
  ...
  if( debug ) {
    ...
    sprintf(filenamePNG, "./slhc-plots/rate/EG/%s/isoStudies/png/rlx_eg_Iso_PU_%0.2f.png" , PUopt.Data(), PUCut);
    sprintf(filenameEPS, "./slhc-plots/rate/EG/%s/isoStudies/eps/rlx_eg_Iso_PU_%0.2f.eps" , PUopt.Data(), PUCut);
