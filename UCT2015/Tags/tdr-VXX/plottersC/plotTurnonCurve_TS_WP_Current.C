...
void plotTurnonCurve(char* var, double min, double max, int NPVmin=0, int NPVmax=50) {
  ...
  for( int k = min_sel; k < max_sel; ++k ) {
    ...
    tree1->Draw(varName+TString(">>l1PtCt20"),TString(cuts)+TString(" && l1Pt>20. && ")+egsel,"goff");
    tree1->Draw(varName+TString(">>l1PtCt25"),TString(cuts)+TString(" && l1Pt>25. && ")+egsel,"goff");
    tree1->Draw(varName+TString(">>l1PtCt30"),TString(cuts)+TString(" && l1Pt>30. && ")+egsel,"goff");
    tree1->Draw(varName+TString(">>l1PtCt40"),TString(cuts)+TString(" && l1Pt>40. && ")+egsel,"goff");
    tree1->Draw(varName+TString(">>l1PtCt60"),TString(cuts)+TString(" && l1Pt>60. && ")+egsel,"goff");

    //// ---- Now divide by allReco histogram to obtain efficiency ----
    l1Pt20->Divide(l1Pt20, allReco,1.0, 1.0, "B");
    l1Pt25->Divide(l1Pt25, allReco,1.0, 1.0, "B");
    l1Pt30->Divide(l1Pt30, allReco,1.0, 1.0, "B");
    l1Pt40->Divide(l1Pt40, allReco,1.0, 1.0, "B");
    l1Pt60->Divide(l1Pt60, allReco,1.0, 1.0, "B");
    
    //------------------------------------------------------------------------
    // For current Trigger comparison
    l1PtCt20->Divide(l1PtCt20, allReco,1.0, 1.0, "B");
    l1PtCt25->Divide(l1PtCt25, allReco,1.0, 1.0, "B");
    l1PtCt30->Divide(l1PtCt30, allReco,1.0, 1.0, "B");
    l1PtCt40->Divide(l1PtCt40, allReco,1.0, 1.0, "B");
    l1PtCt60->Divide(l1PtCt60, allReco,1.0, 1.0, "B");
    ...
    TLegend* legend = new TLegend(0.52,0.16,0.92,0.39);
     ...
     //legend->AddEntry(l1PtCt20, "Current L1 p_{T} > 20 GeV", "LE");
     legend->AddEntry(l1Pt25, "L1 p_{T} > 25 GeV", "PLE"); 
     //legend->AddEntry(l1PtCt25, "Current L1 p_{T} > 25 GeV", "LE"); 
     legend->AddEntry(l1Pt30, "L1 p_{T} > 30 GeV", "PLE"); 
     //legend->AddEntry(l1PtCt30, "Current L1 p_{T} > 30 GeV", "LE"); 
     legend->AddEntry(l1Pt40, "L1 p_{T} > 40 GeV", "PLE"); 
     //legend->AddEntry(l1PtCt40, "Current L1 p_{T} > 40 GeV", "LE"); 
     legend->AddEntry(l1Pt60, "L1 p_{T} > 60 GeV", "PLE"); 
     //legend->AddEntry(l1PtCt60, "Current L1 p_{T} > 60 GeV", "LE"); 
     ...
     TLatex * tex = new TLatex(14.25,1.10, legend_Label.Data() );
     tex->SetTextFont(42);
     tex->SetTextSize(0.04);
     tex->SetLineWidth(2);
     tex->Draw();

     tex = new TLatex(14.25,1.025134, legend_Label_Current.Data() );
     tex->SetTextFont(42);
     tex->SetTextSize(0.04);
     tex->SetLineWidth(2);
     tex->Draw();
