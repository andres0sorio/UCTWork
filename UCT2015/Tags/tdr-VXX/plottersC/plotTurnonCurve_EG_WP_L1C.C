...
void plotTurnonCurve( const char* var, double min, double max, int NPVmin, int NPVmax) {
  ...
  for( int k = min_sel; k < max_sel; ++k ) {
    ...
    l1Pt35->Divide(l1Pt35, allReco,1.0,1.0,"B");
    l1Pt40->Divide(l1Pt40, allReco,1.0,1.0,"B");
    l1Pt10->Divide(l1Pt10, allReco,1.0,1.0,"B");

    //------------------------------------------------------------------------
    // For current Trigger comparison
    l1PtCt10->Divide(l1PtCt10, allReco,1.0,1.0,"B");
