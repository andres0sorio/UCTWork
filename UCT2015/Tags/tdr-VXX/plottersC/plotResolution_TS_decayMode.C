...
void plotResolution( ) {
  ...
  if (region == 1 ) {
    ...
    plotResolution("Pt", 0.0, maxPt, "( abs(recoEta) < 1.4 )", "(50,-2.0 , 2.0)", "MuTau_MTcut_EC", region, tdrStyle);
    plotResolution("Eta",0.0, maxPt, "( abs(recoEta) < 1.4 )", "(50,-1.5 , 1.5)", "MuTau_MTcut_EC", region, tdrStyle);
    plotResolution("Phi",0.0, maxPt, "( abs(recoEta) < 1.4 )", "(50,-1.5 , 1.5)", "MuTau_MTcut_EC", region, tdrStyle);
    
  } else {
    
    plotResolution("Pt", 0.0, maxPt, "( abs(recoEta) > 1.6 && abs(recoEta) < 2.4 )" , "(50,-2.0 , 2.0)", "MuTau_MTcut_EC", region, tdrStyle);
    plotResolution("Eta",0.0, maxPt, "( abs(recoEta) > 1.6 && abs(recoEta) < 2.4 )" , "(50,-1.5 , 1.5)", "MuTau_MTcut_EC", region, tdrStyle);
    plotResolution("Phi",0.0, maxPt, "( abs(recoEta) > 1.6 && abs(recoEta) < 2.4 )" , "(50,-1.5 , 1.5)", "MuTau_MTcut_EC", region, tdrStyle);
